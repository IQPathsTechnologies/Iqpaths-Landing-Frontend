                ...
                <ul className={styles.pointsList}>
                  ...
                  <li className={styles.point}>
                      <span className={styles.priceDetail}>
                        ...
                        {/* <span className={`${styles.originalPrice} ${course.discountedPrice ? styles.strike : ""}`}>Rs. {course.realPrice}</span>{" "} */}
                        {course?.status == "coming soon"?<span className={`${styles.priceDetail}  `} style={{ color: ' #0047B2' }}>Price will be announced soon</span>:<span className={styles.discountedPrice}>Rs. {course.price}</span>}
                      </span>
                  </li>
                </ul>
              </div>
