...
const CourseDetails = () => {
  ...
  const [courseDetails, setCourseDetails] = useState({}); // ✅ FIXED
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        console.log("CourseDetails :: fetchData :: error", error);
      }
    }
    fetchData();
  }, [id]);
  ...
  useEffect(() => {
    async function fetchReviews() {
      try {
        ...
        console.log("CourseDetails :: fetchReviews :: error", error);
      }
    }
    fetchReviews();
  }, [id]);
          ...
          <div key={index} className={styles.section}>
            ...
            >
              ...
              <span className={styles.arrowIcon}>
                <img src={openDropdown === index ? "/upArrow.png" : "/downArrow.png"} alt="Toggle" />
              </span>
            </div>
            {openDropdown === index && (
